import svgPaths from "./svg-wxcs037pi0";
...
function TaskDetail({ className }: { className?: string }) {
  return (
    <div className={className || "content-stretch flex flex-col gap-[2px] items-start relative w-[203px]"} data-name="task_detail">
      <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="title">
        <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[0.15px] whitespace-nowrap">每天芯片热点</p>
        <div className="bg-[#206cff] content-stretch flex items-center justify-center px-[6px] py-[2px] relative rounded-[10px] shrink-0" data-name="notice">
          <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[10px] text-white whitespace-nowrap">定时任务</p>
        </div>
      </div>
      <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[16px] min-w-full not-italic overflow-hidden relative shrink-0 text-[12px] text-[rgba(60,60,67,0.6)] text-ellipsis tracking-[0.4px] w-[min-content]">请整理每日芯片行业的热点新闻和趋势，确保信息准确且及时更新，方便团队快速掌握最新动态。</p>
    </div>
  );
}
...
function HistoryCard({ className }: { className?: string }) {
  return (
    <div className={className || "bg-white content-stretch flex flex-col gap-[24px] h-[538px] items-start px-[32px] py-[24px] relative rounded-[24px] w-[300px]"} data-name="history_card">
      <p className="font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[22px] text-black whitespace-nowrap">任务</p>
      <div className="content-stretch flex flex-col gap-[28px] items-start relative shrink-0 w-full" data-name="Container">
        <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" data-name="task_detail">
          <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="title">
            <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[0.15px] whitespace-nowrap">工作总结</p>
            <div className="bg-[#b2e40d] content-stretch flex items-center justify-center px-[6px] py-[2px] relative rounded-[10px] shrink-0" data-name="notice">
              <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[10px] text-black whitespace-nowrap">进行中</p>
            </div>
          </div>
          <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[16px] min-w-full not-italic overflow-hidden relative shrink-0 text-[12px] text-[rgba(60,60,67,0.6)] text-ellipsis tracking-[0.4px] w-[min-content]">整理会议内容，给相关人员发邮件</p>
        </div>
        <TaskDetail className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" />
        <div className="content-stretch flex flex-col gap-[2px] items-start relative shrink-0 w-full" data-name="task_detail">
          <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="title">
            <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[0.15px] whitespace-nowrap">整理邮件</p>
            <div className="bg-[#206cff] content-stretch flex items-center justify-center px-[6px] py-[2px] relative rounded-[10px] shrink-0" data-name="notice">
              <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[10px] text-white whitespace-nowrap">定时任务</p>
            </div>
          </div>
          <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[16px] min-w-full not-italic overflow-hidden relative shrink-0 text-[12px] text-[rgba(60,60,67,0.6)] text-ellipsis tracking-[0.4px] w-[min-content]">请每天汇总芯片行业的最新热点新闻和趋势，确保信息准确及时，方便团队迅速了解最新动态。</p>
        </div>
        <div className="content-stretch flex flex-col gap-[2px] items-start opacity-30 relative shrink-0 w-full" data-name="task_detail">
          <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="title">
            <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[24px] not-italic relative shrink-0 text-[16px] text-black tracking-[0.15px] whitespace-nowrap">整理电子邮件</p>
          </div>
          <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[16px] min-w-full not-italic overflow-hidden relative shrink-0 text-[12px] text-[rgba(60,60,67,0.6)] text-ellipsis tracking-[0.4px] w-[min-content]">每天汇总芯片行业最新热点和趋势，确保信息准确及时，帮助团队快速掌握最新动态。</p>
        </div>
      </div>
    </div>
  );
...
export default function Component({ className }: { className?: string }) {
  return (
    <div className={className || "content-stretch flex h-[1080px] isolate items-start overflow-clip relative rounded-[24px] w-[1440px]"} data-name="05 对话窗口_展开任务">
      ...
      <div className="bg-[#232323] flex-[1_0_0] h-full min-h-px min-w-px relative z-[1]" data-name="Main">
        <div className="flex flex-row items-center overflow-clip rounded-[inherit] size-full">
          <div className="content-stretch flex gap-[8px] items-center pr-[8px] py-[8px] relative size-full">
            <div className="bg-white content-stretch flex flex-[1_0_0] h-full items-start min-h-px min-w-px overflow-clip relative rounded-[20px]" data-name="Background+Border+Shadow">
                                ...
                                <div className="flex-[199_0_0] min-h-px min-w-px relative" data-name="Container">
                                  <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[2px] items-start relative w-full">
                                    <div className="content-stretch flex items-center justify-between relative shrink-0 w-full" data-name="Container">
                                      <div className="relative shrink-0" data-name="title">
                                        <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex gap-[4px] items-center relative">
                                          <p className="font-['Inter:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-black tracking-[0.1px] whitespace-nowrap">项目负责人</p>
            ...
            <div className="content-stretch flex flex-col gap-[8px] h-full items-start justify-center relative shrink-0">
              <div className="bg-white content-stretch flex flex-col gap-[28px] h-[420px] items-start px-[32px] py-[28px] relative rounded-[24px] shrink-0 w-[300px]" data-name="task_card">
                <p className="font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[28px] not-italic relative shrink-0 text-[22px] text-black whitespace-nowrap">当前计划</p>
                <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Container">
                  <div className="content-stretch flex gap-[16px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    <div className="relative shrink-0 size-[24px]" data-name="Icons / Check Circle">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
                          <g id="Vector" />
                        </svg>
                        <div className="absolute inset-[8.33%]" data-name="Vector">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                            <path d={svgPaths.p25adcd00} fill="var(--fill-0, #35C44F)" id="Vector" />
                          </svg>
                        </div>
                      </div>
                    </div>
                    <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(60,60,67,0.6)] tracking-[0.1px] whitespace-nowrap">已理解你的工作目标</p>
                  </div>
                  <div className="content-stretch flex gap-[16px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    <div className="relative shrink-0 size-[24px]" data-name="Icons / Check Circle">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
                    ...
                    <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(60,60,67,0.6)] tracking-[0.1px] whitespace-nowrap">已匹配基础能力</p>
                  </div>
                  <div className="content-stretch flex gap-[16px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    <div className="relative shrink-0 size-[24px]" data-name="Icons / Radio Button Checked">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
                        <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 32 32">
                          <g id="Vector" />
                        </svg>
                        <div className="absolute inset-[8.33%]" data-name="Vector">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                            <path d={svgPaths.p3a58b490} fill="var(--fill-0, #35C44F)" id="Vector" />
                          </svg>
                        </div>
                        <div className="absolute inset-[29.17%]" data-name="Vector">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 10 10">
                            <path d={svgPaths.p46c6500} fill="var(--fill-0, #35C44F)" id="Vector" />
                          </svg>
                        </div>
                      </div>
                    </div>
                    <p className="flex-[1_0_0] font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[20px] min-h-px min-w-px not-italic relative text-[14px] text-black tracking-[0.1px]">正在生成工作规则</p>
                      ...
                      <div className="flex-none rotate-90">
                        <div className="relative size-[16px]" data-name="Icon">
                          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 16 16">
                            <g id="Icon">
                              <path d={svgPaths.pa5a5370} id="Vector" stroke="var(--stroke-0, #B2E40D)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.33333" />
                            </g>
                          </svg>
                        </div>
                      </div>
                  ...
                  <div className="content-stretch flex gap-[16px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    ...
                    <p className="font-['Inter:Medium','Noto_Sans_JP:Medium','Noto_Sans_SC:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.2)] tracking-[0.1px] whitespace-nowrap">正在检查权限边界</p>
                  </div>
                  <div className="content-stretch flex gap-[16px] h-[24px] items-center relative shrink-0 w-full" data-name="Container">
                    <div className="relative shrink-0 size-[24px]" data-name="Icons / Check Circle">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid overflow-clip relative rounded-[inherit] size-full">
                    ...
                    <p className="font-['Inter:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium leading-[20px] not-italic relative shrink-0 text-[14px] text-[rgba(0,0,0,0.2)] tracking-[0.1px] whitespace-nowrap">即将完成初始化</p>
                  </div>
                </div>
              </div>
              <HistoryCard className="bg-white flex-[1_0_0] min-h-px min-w-px relative rounded-[24px] w-[300px]" />
            </div>
          </div>
        </div>
      </div>
