import svgPaths from "./svg-0iz1fgoiom";
import imgEllipse4 from "figma:asset/0858fcf6163b3883868d9d84fba28ff5c66fb999.png";
import img from "figma:asset/9b9f0881d219021e83d4d96b0db4ad5c55e1255b.png";

export default function Component({ className }: { className?: string }) {
  return (
    <div className={className || "content-stretch flex h-[1080px] isolate items-start overflow-clip relative rounded-[24px] w-[1440px]"} data-name="04 加载页">
                ...
                <div className="content-stretch flex flex-col items-center px-[60px] relative size-full">
                  <div className="flex-[1_0_0] max-w-[768px] min-h-px min-w-px relative w-full" data-name="Step1">
                    <div className="flex flex-col items-center justify-center max-w-[inherit] size-full">
                      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col items-center justify-center max-w-[inherit] py-[48px] relative size-full">
                        <div className="relative shrink-0" data-name="Container">
                          <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[24px] items-center pb-[32px] relative">
                            <div className="grid-cols-[max-content] grid-rows-[max-content] inline-grid leading-[0] place-items-start relative shrink-0" data-name="Profile Image">
                              <div className="col-1 ml-0 mt-0 relative row-1 size-[108px]">
                                <img alt="" className="absolute block max-w-none size-full" height="108" src={imgEllipse4} width="108" />
                              </div>
                              <div className="col-1 ml-[8px] mt-[8px] relative rounded-[57.5px] row-1 size-[92px]" data-name="头像">
                                <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[57.5px] size-full" src={img} />
                              </div>
                            </div>
                            <div className="content-stretch flex flex-col gap-[8px] items-center not-italic relative shrink-0" data-name="Container">
                              <p className="font-['Inter:Bold','Noto_Sans_JP:Bold','Noto_Sans_SC:Bold',sans-serif] font-bold leading-[36px] min-w-full relative shrink-0 text-[28px] text-black text-center w-[min-content]">正在为你准备数字员工</p>
                              <p className="font-['Inter:Regular','Noto_Sans_JP:Regular','Noto_Sans_SC:Regular',sans-serif] font-normal leading-[24px] relative shrink-0 text-[16px] text-[rgba(60,60,67,0.6)] tracking-[0.5px] whitespace-nowrap">请稍作等待，系统正在进行最终的配置与联调...</p>
                            </div>
                          </div>
                        </div>
                      </div>
